...
// A matrix a[n][m] is given, and we have to find the sum on some submatrix (x1,y1)-(x2,y2)
// as well as perform modifications of individual matrix elements (i.e. a[x][y]=p).
int a[n][m], t[4 * n][4 * m];
